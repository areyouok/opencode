...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      session_active_child_1: z.string().optional().default("<leader>1").describe("Go to newest active sub-agent"),
      session_active_child_2: z.string().optional().default("<leader>2").describe("Go to 2nd newest active sub-agent"),
      session_active_child_3: z.string().optional().default("<leader>3").describe("Go to 3rd newest active sub-agent"),
      session_active_child_4: z.string().optional().default("<leader>4").describe("Go to 4th newest active sub-agent"),
      session_active_child_5: z.string().optional().default("<leader>5").describe("Go to 5th newest active sub-agent"),
      session_active_child_6: z.string().optional().default("<leader>6").describe("Go to 6th newest active sub-agent"),
      session_active_child_7: z.string().optional().default("<leader>7").describe("Go to 7th newest active sub-agent"),
      session_active_child_8: z.string().optional().default("<leader>8").describe("Go to 8th newest active sub-agent"),
      session_active_child_9: z.string().optional().default("<leader>9").describe("Go to 9th newest active sub-agent"),
